...
const RotatingClockGame = () => {
  ...
  const handleStart = (clientX, clientY) => {
    ...
    setStartAngle(angle);
    lastAngleRef.current = angle; // Set the last angle to the current angle
  ...
  const handleEnd = () => {
    setIsDragging(false);
    setRotation((prevRotation) => prevRotation % 360); // Ensure rotation stays within 0-360 degrees
  };
