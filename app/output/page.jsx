    ...
    return (
        <div className="h-screen bg-black text-white relative overflow-hidden">
            ...
            <div className="relative">
                ...
                />
                <div
                    className="w-[315px] p-2.5 bg-customFon rounded-xl border-[1px] border-customBorder relative z-10 mx-auto">
                    <div className="border-after-two">
                        ...
                        <p className="text-customGray2 text-xs mb-2.5">When choosing a broker, the money will be sent to
                            the personal account of the selected broker</p>
                    </div>
                ...
                <div
                    className="w-[315px] [h-100px] p-2.5 bg-customFon rounded-xl border-[1px] border-customBorder relative z-10 mx-auto mt-[30px] flex flex-row gap-2.5">
                    <div className="flex flex-col">
                        <div className="flex flex-row justify-between items-center py-1">
                            <h2 className="text-lg font-normal">Your wallet</h2>
                            <p className="text-xs font-normal gradient-text">min 50USDT</p>
                        </div>
                        <p className="text-customGray2 text-xs w-[185px]">The withdrawal fee is calculated individually from the
                            selected exchange</p>
                    </div>
                    <div className="px-[12.5px] py-[2.5px]"
                         onTouchStart={handleTouchStart}
                         onTouchEnd={handleTouchEnd}>
                        <Image src={isTouched ? "walletHover.svg" : "/wallet.svg"} alt="wallet" width={75} height={75}
